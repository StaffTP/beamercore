package me.hulipvp.hcf.utils.chat;
...
/**
 * Represents a formattable message. Such messages can use elements such as colors, formatting codes, hover and click backend, and other features provided by the vanilla Minecraft <a href="http://minecraft.gamepedia.com/Tellraw#Raw_JSON_Text">JSON message formatter</a>.
	...
	*/
    ...
    public void writeJson(JsonWriter writer) throws IOException {
        if(messageParts.size() == 1) {
            ...
            writer.beginObject().name("text").value("").name("me/hulipvp/hcf/utils/chat").beginArray();
    ...
    public static FancyMessage deserialize(String json) {
        ...
        JsonArray extra = serialized.getAsJsonArray("me/hulipvp/hcf/utils/chat"); // Get the utils component
