...
public class ItemNames {
    ...
    public static String lookup(ItemStack stack) {
        ...
        if((material == Material.WOOL || material == Material.CARPET) && stack.getDurability() == 0) {
            result = map.get(key);
        } else if(material == Material.WOOL || material == Material.CARPET || material == Material.STAINED_CLAY || material == Material.STAINED_GLASS || material == Material.STAINED_GLASS_PANE) {
